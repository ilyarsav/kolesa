...
import style from "./SubCatAccessories.module.css";

const SubCatAccessories = () => {
  ...
  useEffect(() => {
    const wheelsShopData = async () => {
      const res = await fetch(
        "http://qoldan-dev.com/api/car/spare_parts_cat/get_accessories_and_multimedia"
      ).then((res) => res.json());
...
export default SubCatAccessories;
